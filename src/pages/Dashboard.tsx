...
const Dashboard: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className={`bg-background ${paddingClass}`}>
        <div className={`mx-auto ${maxWidthClass}`}>
          ...
          <div className={`mb-8 sm:mb-12 grid gap-4 sm:gap-6 ${isMobile ? 'grid-cols-1' : isTablet ? 'grid-cols-2' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4'}`}>
            {/* Total Analyses */}
            <div className="rounded-xl bg-white p-4 sm:p-6 shadow-md transition hover:shadow-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-600">Total Analyses</p>
                ...
                <div className="rounded-lg bg-primary-50 p-3 sm:p-4 flex-shrink-0">
            ...
            <div className="rounded-xl bg-white p-4 sm:p-6 shadow-md transition hover:shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="rounded-lg bg-success-50 p-3 sm:p-4 flex-shrink-0">
            ...
            <div className="rounded-xl bg-white p-4 sm:p-6 shadow-md transition hover:shadow-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-600">This Month</p>
                ...
                <div className="rounded-lg bg-blue-50 p-3 sm:p-4 flex-shrink-0">
            ...
            <div className="rounded-xl bg-white p-4 sm:p-6 shadow-md transition hover:shadow-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-600">Avg Confidence</p>
                ...
                <div className="rounded-lg bg-orange-50 p-3 sm:p-4 flex-shrink-0">
          ...
          {recentAnalyses.length > 0 ? (
            <div className="mb-8 sm:mb-12 rounded-xl bg-white p-4 sm:p-6 lg:p-8 shadow-md">
              <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h2 className="text-xl sm:text-2xl font-bold text-[#333333]">Recent Analyses</h2>
                <Link
                  to="/history"
                  ...
                  {recentAnalyses.map(analysis => (
                    <div key={analysis.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium text-gray-800 text-sm truncate">{analysis.fileName}</h3>
                          <p className="text-xs text-gray-600">{new Date(analysis.uploadedAt).toLocaleDateString()}</p>
                        </div>
                      ...
                      <div className="flex items-center justify-center gap-2">
                        <Link
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-1 rounded-lg bg-primary-50 px-3 py-2 text-xs font-semibold text-primary transition hover:bg-primary hover:text-white"
                        >
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Image Name</th>
                        ...
                        <tr key={analysis.id} className="border-b border-gray-100 hover:bg-gray-50 transition">
                          ...
                          <td className="px-4 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <Link
                                to={`/results/${analysis.id}`}
                                className="inline-flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-1 text-sm font-semibold text-primary transition hover:bg-primary hover:text-white"
                              >
            ...
            <div className="mb-8 sm:mb-12 rounded-xl bg-white p-8 shadow-md">
              <div className="flex flex-col items-center justify-center py-8 sm:py-12">
                <svg className="mb-4 h-12 w-12 sm:h-20 sm:w-20 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <h3 className="text-lg font-bold text-gray-800 text-center">No Analyses Yet</h3>
                <p className="mt-2 text-center text-gray-600 max-w-sm text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl bg-blue-600 p-4 sm:p-6 text-white shadow-md">
            ...
            <div className="rounded-xl bg-green-600 p-4 sm:p-6 text-white shadow-md">
              <div className="mb-3 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white bg-opacity-20">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Card 3 - Quick Tip */}
            <div className="rounded-xl bg-orange-500 p-4 sm:p-6 text-white shadow-md">
              <div className="mb-3 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white bg-opacity-20">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
